...
export const fetchPhotoById = createAsyncThunk(
    ...
    async (id: string | undefined, thunkApi) => {
        const response = await axios.get<IImages>(baseUrl + `items/${id}?populate=*`)
        return response.data.data
    }
)
...
export const fetchInfoAboutUs = createAsyncThunk(
    ...
    async (_, thunkApi) => {
        ...
        const response = await axios.get<IAboutUsResponse>(baseUrl + 'about-uses?populate=*')
...
export const fetchServicePricesStages = createAsyncThunk(
    ...
    async (_, thunkApi) => {
        ...
        const response = await axios.get<IAboutUsResponse>(baseUrl + 'design-stages?populate=*')
        return response.data.data
    }
)
export const fetchBlogs = createAsyncThunk(
    'blogs',
    async (_, thunkApi) => {
        const response = await axios.get<IAboutUsResponse>(baseUrl + 'blogs?populate=*')
        return response.data.data
    }
)
export const fetchBlog = createAsyncThunk(
    ...
    async (id: string | undefined, thunkApi) => {
        ...
        const response = await axios.get<IAboutUsResponse>(baseUrl + `blogs/${id}?populate=*`)
        return response.data.data
    }
)
